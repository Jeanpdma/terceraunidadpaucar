...
class KanbanController extends Controller
{
    ...
    public function crearTarea(Request $request, int $columnaId)
    {
        ...
        try {
            ...
            return response()->json(['success' => false, 'mensaje' => 'Error al crear la tarea: ' . $e->getMessage()], 500);
        }
    }
    ...
    {
        try {
            $tarea = Tarea::findOrFail($tareaId); // Obtener la tarea directamente
    ...
    public function editarTarea(Request $request, int $tareaId)
    {
        ...
        try {
            ...
            return response()->json(['success' => false, 'mensaje' => 'Error al actualizar la tarea: ' . $e->getMessage()], 500);
        }
    }
    ...
    public function subirArchivo(Request $request, int $tareaId)
    {
        try {
            ...
            return response()->json(['success' => true, 'mensaje' => 'Archivo subido correctamente', 'version' => $version]);
        } catch (\Exception $e) {
            return response()->json(['success' => false, 'message' => $e->getMessage()], 500);
        }
    }
